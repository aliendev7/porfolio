...
// Duplicate of `/api/resource-categories/[slug]` (admin UI consumer). Kept
// behaviorally identical. See docs/API_INTEGRATION.md.
...
export async function GET(request: NextRequest, { params }: { params: { slug: string } }) {
    try {
        ...
        return serverError(error, "Failed to fetch category");
    }
}
